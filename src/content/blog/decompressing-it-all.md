---
title: Decompressing It All
description: Some thoughts I wanted to pen down that have been churning around.
date: 2026-09-04
---

Recently, I've been ruminating over a lot of different thoughts and different writing drafts in my head. There is an idea and enough energy for it to reach the page, but not get published.

I was waiting to see if motivation will strike for me to tackle atleast one of the topics I've left open, but I've had no luck so far. And I definitely don't want to force it too much. That's around the time I realized that I have complete artistic freedom on this blog.

So this is me expelling all the little bits of thoughts and information I've collected over the past little while. After this post, I'll see what still sticks around (what I still feel like writing about) and move forward with that.
...
Every other post was a news channel blaring information at full volume. The information didn't have to be right, or even coherent. It was just loud. All of them featured a lot of red, and were placed right alongside loving memories from family and friends.

The first feeling was ofcourse, rage; the place where all blogposts start[^1]. This was as good as someone harassing my grandparents in front of me. Worse, the takeaway they have from this messes with all their other conversations they have with _real people_.

This also made me think that Facebook had as good as scammed them. They joined the platform when it was just a "live photo album" that updated with memories of their closest loved ones. From there, it slowly descended into trying to engage their attention into other places against their will.

My grandparents don't know what a "digital detox" is. They didn't grow up learning to create distinction between what's real and what's online. They can't tell when something online is real, or hell, even _too much_ to handle.

This was, ofcourse, accelerated even farther with the introduction of AI content into their feeds. Cats dancing and babies talking is one thing, but meticulously altered content striving for an extreme reaction is really, really fucked. I hate it.

The blogpost regarding this started off as a satirical guide on protecting my grandparents from the Algorithm. The satirical part is that I can't, because Meta literally doesn't have a single "OFF" button on any part of what you see. You can check these in your Meta Accounts Center right now:

1. Want to disable political content? All content that we know _is_ political? You can't, you can only see "Less".
2. Want to disable sensitive content? Stuff that's too graphic or violence-intensive or obscene? You can't, there just an option for "Less".

Want to disable AI content? THERE IS NO TOGGLE FOR THAT. You know how you can see less of it? **On every single AI-generated post that you see -- and have distinguished yourself is AI-generated -- you have to go into the "three dots" and click on "Not Interested"**.

There's no setting nor guide on understanding this either. You know how I got to know this? _Through the Meta AI Support Assistant that exists in the settings_. I hated every second of this discovery.

You can tell I have a lot of thoughts already, but I currently feel like I have this obligation to make this all more coherent and structured. A narrative that builds up or leads to a result or gives you a takeaway you haven't had before. But I'm starting to think that's not a revelation I should wait for.
...
The main feeling I have for this right now is as follows.
...
I'll see if this post evolves into something else.

### Impatience

We recently (but long ago, at this point) had a discussion in [IndieWebClub](https://blr.indiewebclub.org/) prompted by me discussing heightened surveillance around [the NEET protests](https://en.wikipedia.org/wiki/2026_Delhi_Jantar_Mantar_protests). The subsequent chats wondered why Indians do not speak up against increasing breaches to privacy, and here is something I want to highlight from Ashwin:
...
I started out replying with some thoughts I had, which soon turned into _many_ thoughts. I realized I need to give them the time and space to exist, which started the journey of the draft.

There is a lot of content on the draft right now (without a real motive), but the core of my answer to the question above was "India just doesn't have time for it."
...
Not much to say here, just dropping a teaser that I'm meticulously comparing all the chai premixes I can get my hands on and finding out which one I like the best. I'll be dropping a comprehensive post on that soon&trade;.

Just thought I'd leave something positive in here. :)
...
[^1]: Not really but most of them. I just wanted to use a footnote here. :P
